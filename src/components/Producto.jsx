...
export const Producto = ({ producto }) => {
    ...
    const { modal, setProductoPedido, obtenerProductoBuscar, cargando } = useContext(ProductosContext);
    ...
    return (
        <>
            ...
            >
                <img src={imagen ? imagen : Imagen} alt="iconoProducto" style={{maxHeight:"230px"}}/>
                ...
                <input type="button" className='btn btn-warning text-uppercase fw-bolder' onClick={() => handleClick(producto)} value="VER MAS" disabled={cargando ? true : false} />
            </div>
